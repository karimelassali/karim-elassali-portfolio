    ...
    <div id='certifications'>
        ...
        <div  className="w-full grid grid-cols-3 md:grid-cols-2 max-sm:grid-cols-1">
        {
            certificates.map((certificate, index) => (
                ...
                >
                    <h2 className="text-white text-2xl flex justify-between text-left font-bold">
                        {certificate.name}
                        <AvatarCircles
                        avatarUrls={[
                            { imageUrl: certificate.provider + '.svg', profileUrl: 'https://'+ certificate.provider +'.com'},
                            // Add more Avatar objects if needed
                        ]}
                        />                    
                        </h2>
